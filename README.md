...
```
Problem
- Files need Blobsha's before they can be modified by CoPilot
- These are best generated by uploading using GitHub Desktop
- New cloned projects from Github do not have a Blobsha
- So project files need to be saved locally, then uploaded
